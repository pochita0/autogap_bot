...
export const goldenOpportunities: Opportunity[] = [
  ...
  // ============================================================================
  // KIMCHI PREMIUM EDGE CASES (Testing new opportunity types)
  // ============================================================================

  {
    id: 'kimp-below-min-gap',
    ...
    sellExchange: 'Bithumb',
    buyPrice: 60000, // USD
    sellPrice: 81180000, // KRW (Gap: 0.45% - below min)
    grossGapPct: 0.45,
    netProfitPct: 0.28,
    commonNetworks: 1,
    walletStatusOk: true,
...

  {
    ...
    buyPrice: 3037500, // KRW
    sellPrice: 2250, // USD (Gap: exactly 0.50%)
    grossGapPct: 0.50,
    netProfitPct: 0.32,
    commonNetworks: 2,
    walletStatusOk: true,
...

  {
    ...
    sellExchange: 'Bithumb',
    buyPrice: 0.152, // USD
    sellPrice: 212, // KRW (Gap: 3.5% but no common network)
    grossGapPct: 3.52,
    netProfitPct: 2.75,
    commonNetworks: 0,
    walletStatusOk: false,
...

  {
    ...
    sellExchange: 'Bithumb',
    buyPrice: 0.520, // USD
    sellPrice: 735, // KRW (Gap: 4.8% - high kimchi premium)
    grossGapPct: 4.82,
    netProfitPct: 4.05,
    commonNetworks: 1,
    walletStatusOk: true,
  ...
  {
    id: 'kimp-net-profit-below-threshold',
    type: 'KIMP_BITHUMB_TO_OVERSEAS',
    base: 'SOL',
    quote: 'KRW',
    buyExchange: 'Bithumb',
    sellExchange: 'OKX',
    buyPrice: 128500, // KRW
    sellPrice: 95.2, // USD (Gap: 0.55% but net profit: 0.25% - below 0.3% threshold)
    grossGapPct: 0.55,
    netProfitPct: 0.25,
    commonNetworks: 1,
    walletStatusOk: true,
  ...
  {
    id: 'kimp-net-profit-at-threshold',
    type: 'KIMP_OVERSEAS_TO_BITHUMB',
    base: 'MATIC',
    quote: 'KRW',
    buyExchange: 'Binance',
    sellExchange: 'Bithumb',
    buyPrice: 0.850, // USD
    sellPrice: 1160, // KRW (Net profit: exactly 0.30%)
    grossGapPct: 1.12,
    netProfitPct: 0.30,
    commonNetworks: 2,
    walletStatusOk: true,
...
export function getFixtureStats() {
  return {
    ...
    byStrategy: {
      ...
      kimpOverseasToBithumb: goldenOpportunities.filter(o => o.type === 'KIMP_OVERSEAS_TO_BITHUMB').length,
      kimpBithumbToOverseas: goldenOpportunities.filter(o => o.type === 'KIMP_BITHUMB_TO_OVERSEAS').length,
    },
    byRouteType: {
